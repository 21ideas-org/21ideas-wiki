...
h1: "BIP-49: Derivation scheme for P2WPKH-nested-in-P2SH based accounts"
author: "Daniel Weigl"
description: "Bitcoin Improvement Proposal 49 — Derivation scheme for P2WPKH-nested-in-P2SH based accounts."
url: https://github.com/bitcoin/bips/blob/master/bip-0049.mediawiki
source_domain: github.com
category: theory/protocol
language: en
license: "Public domain"
tags: [bip, derivation-paths, nested-segwit, p2sh, ypub]
date: 2016-05-19
---
...
With the usage of P2WPKH-nested-in-P2SH (BIP 141) transactions it is necessary to have a common derivation scheme.
...
BIP 44, but only uses a different purpose value to indicate the different transaction
...
Additional registered version bytes are listed in [SLIP-0132](https://github.com/satoshilabs/slips/blob/master/slip-0132.md).
