...
Биткоин не возник из ниоткуда. За сорок лет до его появления криптографы, программисты и активисты движения [[ru/entities/cypherpunks|шифропанков]] разрабатывали инструменты, идеи и прототипы, ставшие прямыми предшественниками Биткоина.
...
[[ru/entities/cypherpunks|Шифропанк]] Адам Бэк предложил **Hashcash** — систему Proof of Work на основе хэш-функций. Изначально для борьбы со спамом: отправитель должен доказать, что затратил вычислительные ресурсы.
...
→ Подробнее: [[ru/concepts/hashcash]]
...
[[ru/entities/nick-szabo|Ник Сабо]] разработал **Bit Gold** — цифровые деньги, где редкость обеспечивается вычислительной работой (Proof of Work).
...
[[ru/entities/hal-finney|Хэл Финни]] создал **RPOW** (Reusable Proof of Work) — систему «повторно используемых» токенов Proof of Work. Токены можно было тратить один раз, получая новые взамен — функция, аналогичная монетам.
...
В октябре 2008 года [[ru/entities/satoshi-nakamoto|Сатоши Накамото]] опубликовал белую книгу «Bitcoin: A Peer-to-Peer Electronic Cash System». Он решил ключевые проблемы всех предшественников:
...
- [[ru/entities/hal-finney]] — RPOW и первый пользователь Биткоина
- [[ru/entities/nick-szabo]] — Bit Gold
