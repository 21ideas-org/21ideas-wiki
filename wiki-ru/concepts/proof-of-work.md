...
Для добавления блока майнер должен найти такой **[[ru/glossary|нонс]]** (произвольное число), чтобы хэш заголовка блока был меньше целевого значения (target). Это выглядит как строка с большим числом ведущих нулей:
...
- [[ru/concepts/scarcity]] — связь PoW с редкостью биткоина
- [[ru/concepts/hashcash]] — исторический предшественник PoW в Биткоине
- [[ru/glossary]] — термины: хешрейт, нонс, сложность, корректировка сложности
