...
Если [[ru/glossary#Блок|блок]] **отвергнут** (победила другая ветка с большей работой), транзакции из отброшенного блока возвращаются в мемпул, **если остаются валидны** относительно новой цепи с большей проделанной работой. Конфликтующие траты разрешаются правилами цепи и порядком включения.
