...
Все современные кошельки используют **[[ru/glossary|сид-фразу]]** (seed phrase / мнемоническую фразу) — 12 или 24 обычных слова, из которых математически выводятся все приватные ключи кошелька.
...
[[ru/concepts/multisig|Мультиподпись]] (multisig) — схема `m-из-n`, при которой для авторизации транзакции нужно `m` ключей из `n` существующих. Например, 2-из-3 или 3-из-5.
...
- [[ru/concepts/multisig]] — мультиподпись подробно
- [[ru/practice/storage]] — практические руководства по кошелькам
- [[ru/concepts/privacy]] — приватность и хранение
- [[ru/glossary]] — аппаратный кошелёк, сид-фраза, холодное хранение
