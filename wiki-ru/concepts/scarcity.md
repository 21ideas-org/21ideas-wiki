...
2. **Комиссии за транзакции должны покрывать затраты на майнинг в долларах** — но рынок определяет цену безопасности сам, через [[wiki-ru/glossary|корректировку сложности]].
...
Биткоины эмитируются через [[wiki-ru/concepts/mining|майнинг]]: каждый новый блок (примерно каждые 10 минут) содержит [[wiki-ru/glossary|coinbase-транзакцию]], создающую новые монеты.
...
Каждые **210 000 блоков** (~4 года) субсидия за блок уменьшается вдвое — это и есть [[wiki-ru/glossary|халвинг]]. Механизм гарантирует, что темп инфляции биткоина неуклонно снижается и асимптотически стремится к нулю.
...
- [[wiki-ru/concepts/bitcoin]] — общий обзор
- [[wiki-ru/concepts/proof-of-work]] — связь безопасности с редкостью
- [[wiki-ru/concepts/mining]] — механизм эмиссии
- [[wiki-ru/concepts/money]] — редкость как свойство денег
