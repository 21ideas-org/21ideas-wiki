...
Taproot — обновление протокола Биткоин, активированное 14 ноября 2021 года на блоке 709 632. Оно объединяет три BIP (340, 341, 342) и вводит подписи Шнорра, новый тип адресов P2TR и обновлённый язык скриптов Tapscript. Это крупнейшее обновление Биткоина со времён [[ru/concepts/segwit|SegWit]].
...
**Итог**: любая Taproot-транзакция выглядит в блокчейне одинаково — как обычный платёж на публичный ключ. Нельзя внешне отличить одиночный платёж от [[ru/concepts/multisig|мультисиг]], от сложного смарт-контракта или от [[ru/concepts/lightning-network|Лайтнинг]]-канала.
...
- [[ru/concepts/segwit]] — предшественник, на котором строится Taproot
- [[ru/concepts/lightning-network]] — главный бенефициар Taproot
- [[ru/concepts/multisig]] — мультиподпись с улучшениями Taproot
