...
- **P2WSH** (нативный [[wiki-ru/concepts/segwit|SegWit]]) — более эффективный вариант.
- **P2TR с MuSig2** ([[wiki-ru/concepts/taproot|Taproot]]) — агрегация подписей Шнорра превращает мультисиг в неотличимый от «одиночного» ключа, используемого в обычных транзакциях. Максимальная приватность.

*Подробнее о разных видах адресов читайте [[wiki-ru/concepts/address-types|здесь]]*
...
- [[wiki-ru/concepts/security]] — общая безопасность и хранение
- [[wiki-ru/concepts/taproot]] — MuSig2 и Taproot-мультисиг
- [[wiki-ru/concepts/address-types]] — типы адресов для мультисиг
- [[wiki-ru/practice/storage]] — практические руководства
- [[wiki-ru/glossary]] — мультиподпись, UTXO, холодное хранение
