...
Hashcash — система [[wiki-ru/concepts/proof-of-work|доказательства работы]], разработанная криптографом Адамом Бэком в 1997 году. Первоначально создавалась для борьбы со спамом, но заложила концептуальный фундамент для алгоритма консенсуса Биткоина.
...
- **Независимость**: каждое письмо требует нового [[wiki-ru/concepts/proof-of-work|Proof of Work]] (нонс специфичен для каждого конкретного письма).
...
- [[wiki-ru/concepts/proof-of-work]] — PoW в Биткоине
- [[wiki-ru/concepts/mining]] — реализация PoW в майнинге
- [[wiki-ru/entities/cypherpunks]] — шифропанки и их вклад
