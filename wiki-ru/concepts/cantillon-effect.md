...
category: concepts
tags: [bitcoin, wiki, cantillon-effect, inflation, monetary-policy, economics]
language: ru
...
6. Постепенно инфляция распространяется на потребительские товары.
...
1. **Нет эмитента**: никто не контролирует производство биткоинов. Новые монеты создаются по фиксированному алгоритму через [[wiki-ru/concepts/mining|майнинг]].

2. **Прозрачность**: темп эмиссии известен заранее каждому участнику. Инфляция Биткоина предсказуема и публична.

3. **Равный доступ**: любой может стать майнером. Новые биткоины распределяются на конкурентной основе, без привилегий.

4. **Убывающая эмиссия**: каждый [[wiki-ru/concepts/scarcity|халвинг]] сокращает субсидию вдвое. Богатеть за счёт инфляции в биткоине не получится — его инфляция асимптотически стремится к нулю.
...
**[[wiki-ru/entities/saifedean-ammous|Сейфедин Аммус]]** в книге «[[wiki-ru/books/fiat-standard|Фиатный стандарт]]» (в пятой главе, «[Фиатные вклады](https://21ideas.org/fiatniy-standart/5/)») рассматривает эффект Кантильона как инженерную особенность архитектуры фиатных денег. Его анализ структурный и системный: механизм «вшит» в саму систему создания кредита центральными банками. Банки получают дешёвые деньги первыми, потому что так устроена система. Государства могут занимать дёшево, потому что находятся ближе всего к «денежному вентилю». Язык Аммуса — экономический и клинический: это не заговор, а предсказуемое следствие централизованной эмиссии денег. В его интерпретации эффект Кантильона — это скрытая субсидия финансовому сектору и государству, оплачиваемая снижением покупательной способности остальных граждан.
...
**Синтез в вики:** Биткоин нейтрализует эффект Кантильона не за счёт «справедливой» эмиссии через политику, а за счёт открытости и конкуренции — благодаря [[wiki-ru/concepts/proof-of-work|Proof of Work]] любой может участвовать в выпуске новых монет, а правила заранее фиксированы и не требуют доверия к какой-либо институции.

---

## Источники

- [https://21ideas.org/hozyaeva-i-raby-deneg](https://21ideas.org/hozyaeva-i-raby-deneg)

## Связанные страницы

- [[wiki-ru/concepts/money]] — денежная теория
- [[wiki-ru/concepts/scarcity]] — ограниченное предложение Биткоина
- [[wiki-ru/concepts/bitcoin]] — Биткоин как ответ
- [[wiki-ru/series/gradually-then-suddenly]] — экономика Биткоина
