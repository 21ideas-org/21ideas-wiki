...
Серия из четырёх статей от разработчиков кошелька Samourai, опубликованных в блоге OXT Research. Технический анализ [[ru/concepts/privacy|приватности]] биткоин-транзакций: как работает анализ блокчейна и как от него защититься.
...
- Кластеризация адресов: если несколько [[ru/concepts/utxo|UTXO]] использованы как входы транзакции, они, вероятно, принадлежат одному кошельку
...
- [[ru/concepts/privacy]] — основы приватности в Биткоине
- [[ru/concepts/utxo]] — модель UTXO как основа анализа
- [[ru/practice/privacy-practice]] — практические руководства
- [[ru/concepts/lightning-network]] — приватные офчейн-платежи
