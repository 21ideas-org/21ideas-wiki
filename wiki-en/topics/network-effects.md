...
Higher price → higher miner revenue → more miners → more [[en/concepts/mining|hash rate]] → more security.

The security network effect is economic: as Bitcoin's value grows, the cost of attacking it grows proportionally (a 51% attacker must outspend the entire honest [[en/concepts/mining|mining]] network). Higher price also attracts more [[en/concepts/mining|ASIC]] investment and manufacturing, making hash rate growth permanent rather than easily reversible.
...
See [[en/concepts/mining]]] for the hash rate mechanics.
...
The [[en/concepts/lightning-network|Lightning Network]], [[en/concepts/security|multisig]] custody solutions, [[en/concepts/privacy|privacy]] tools, [[en/concepts/security|hardware wallets]] — all built by developers who chose Bitcoin because its base layer is stable enough to build on. Each new application increases Bitcoin's utility and attracts more developers, compounding this effect.
...
The seven [[en/topics/network-effects|network effects]] explain the *mechanism* by which Bitcoin achieves the monetary properties described in [[en/concepts/money]]]:
...
Bitcoin is not adopted because it was declared [[en/concepts/money|money]] by a government. It is being adopted because each network effect makes it more useful, which attracts more users, which strengthens each effect further. This is the market-driven monetary emergence predicted by Austrian economics.
...
[[en/glossary|Glossary]] | [[en/concepts/money|sound money]] | [[en/concepts/bitcoin|Bitcoin]] | [[en/concepts/scarcity|scarcity]] | [[en/concepts/mining|mining]] | [[en/concepts/lightning-network|Lightning Network]] | [[en/books/bullish-case|The Bullish Case for Bitcoin]] | [[en/series/gradually-then-suddenly|Gradually, Then Suddenly]]

## Related Pages

- [[en/concepts/money]]] — monetary theory and why Bitcoin is sound money
- [[en/concepts/bitcoin]]] — Bitcoin's core properties
- [[en/concepts/scarcity]]] — the fixed supply that makes Bitcoin a credible store of value
- [[en/concepts/mining]]] — the security network effect in detail
- [[en/concepts/lightning-network]]] — the financialization network effect
- [[en/series/gradually-then-suddenly]]] — Parker Lewis on Bitcoin's monetization path
- [[en/books/bullish-case]]] — Vijay Boyapati's framework for Bitcoin's monetary emergence
