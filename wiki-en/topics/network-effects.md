...
Higher price → higher miner revenue → more miners → more [[en/glossary#Hash rate|hash rate]] → more security.

The security network effect is economic: as Bitcoin's value grows, the cost of attacking it grows proportionally (a 51% attacker must outspend the entire honest [[en/concepts/mining|Mining]] network). Higher price also attracts more [[en/glossary#ASIC (Application-Specific Integrated Circuit)|ASIC]] investment and manufacturing, making hash rate growth permanent rather than easily reversible.
...
See [[en/concepts/mining|Mining]] for the hash rate mechanics.
...
The [[en/concepts/lightning-network|Lightning Network]], [[en/concepts/multisig|Multisig (Multisignature)]] custody solutions, [[en/concepts/privacy|Privacy]] tools, [[en/glossary#Hardware wallet|hardware wallets]] — all built by developers who chose Bitcoin because its base layer is stable enough to build on. Each new application increases Bitcoin's utility and attracts more developers, compounding this effect.
...
The seven [[en/topics/network-effects|network effects]] explain the *mechanism* by which Bitcoin achieves the monetary properties described in [[en/concepts/money|Money]]:
...
- [[en/concepts/mining|Mining]]
- [[en/concepts/lightning-network|Lightning Network]]
- [[en/books/bullish-case|The Bullish Case for Bitcoin]]
