...
See [[en/history/blocksize-war|Blocksize War]] and [[en/books/blocksize-war|The Blocksize War (book)]] for detailed account.
...
| Aug 1, 2017 | UASF (BIP 148) activates; SegWit forced through user pressure |
...
|------|---------|-------------|
| Aug 2017 | **SegWit** | Fixed transaction malleability; enabled Lightning; ~2x capacity |
| Nov 2021 | **Taproot** | Schnorr signatures, MAST; improved privacy and smart contracts |
| 2023+ | **MuSig2** | Efficient Schnorr multisig; N-of-N looks like single sig on-chain |
...
- [[en/history/pre-bitcoin-cypherpunks|Pre-Bitcoin Cypherpunks — the 20 years before Bitcoin]]
- [[en/history/blocksize-war|Blocksize War — 2015–2017 in detail]]
- [[en/concepts/segwit|SegWit — major 2017 protocol upgrade]]
- [[en/concepts/taproot|Taproot — 2021 protocol upgrade]]
- [[en/entities/satoshi-nakamoto|Satoshi Nakamoto — creator]]
- [[en/entities/hal-finney|Hal Finney — first recipient]]
- [[en/series/genesis-files|Genesis Files — intellectual prehistory]]
- [[en/series/silk-road|Silk Road — first major Bitcoin marketplace]]
