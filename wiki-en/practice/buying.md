...
Most Bitcoin exchanges require [[en/concepts/privacy|KYC]] (Know Your Customer) — passport, ID, sometimes bank statements. The problem: this permanently links your identity to your Bitcoin addresses. Exchange databases get hacked. Governments compel exchanges to report or freeze funds. Once linked, every transaction from those addresses is tracked.

For maximum financial sovereignty, buy no-KYC. See [[en/concepts/privacy]]] for the full argument.

---

## No-KYC Options

### [[en/practice/buying|Hodl Hodl]] (`raw/Practice/buy/hodl-hodl.md`)
[[en/practice/buying|P2P exchange]] (non-custodial). Buyer and seller agree on terms; funds are locked in a 2-of-3 [[en/concepts/security|multisig]] contract (buyer + seller + Hodl Hodl). No ID required. Accepts many payment methods (bank transfer, cash, gift cards).
...
1. Get a Bitcoin wallet first (see [[en/practice/storage]]])
...
The most important step after buying: move your bitcoin to a wallet you control. An exchange balance is not Bitcoin — it is an IOU. See [[en/practice/storage]]] for [[en/concepts/security|self-custody]] options.
...
[[en/glossary|Glossary]] | [[en/concepts/privacy|privacy]] | [[en/concepts/security|self-custody]] | [[en/concepts/utxo|UTXO]] | [[en/practice/storage|cold storage]] | [[en/practice/privacy-practice|privacy practice]] | [[en/practice/lightning-tools|Lightning tools]] | [[en/series/oxt-research|blockchain analysis]]

## Related Pages

- [[en/concepts/privacy]]] — why no-KYC matters
- [[en/practice/storage]]] — where to put your bitcoin after buying
- [[en/practice/lightning-tools]]] — Lightning wallets for RoboSats and Phoenix
