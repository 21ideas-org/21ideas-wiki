...
The right setup depends on the amount you're holding and your threat model. For significant holdings, [[en/concepts/security|hardware wallet]] + [[en/concepts/security|multisig]] is the recommendation.
...
- Supports [[en/glossary|PSBT]] (Partially Signed Bitcoin Transactions)
...
- Key 1: [[en/practice/storage|Coldcard]] (home safe)
- Key 2: [[en/practice/storage|SeedSigner]] (different location)
- Key 3: Unchained Capital collaborative custody (or another [[en/concepts/security|hardware wallet]] with a trusted person)
...
- **12 words** ([[en/concepts/security|seed phrase]]): adequate for most users; smaller backup to store
...
[[en/glossary|Glossary]] | [[en/concepts/security|self-custody]] | [[en/concepts/privacy|privacy]] | [[en/concepts/utxo|UTXO]] | [[en/concepts/address-types|address types]] | [[en/practice/buying|buying Bitcoin]] | [[en/practice/privacy-practice|privacy practice]] | [[en/practice/lightning-tools|Lightning tools]]

## Related Pages

- [[en/concepts/security]]] — detailed security concepts
- [[en/concepts/multisig]]] — comprehensive guide to multisig schemes, PSBT, collaborative custody
- [[en/concepts/privacy]]] — privacy in storage
- [[en/practice/buying]]] — where bitcoin comes from before storage
- [[en/practice/running-a-node]]] — run your own node to validate self-custody transactions
- [[en/practice/lightning-tools]]] — for spending/Lightning amounts
