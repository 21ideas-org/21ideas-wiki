...
- [[en/concepts/mining|Block rewards]] that halve every ~210,000 blocks (~4 years)
...
The 21M cap is enforced by every [[en/concepts/bitcoin-node|full node]] independently. No miner, developer, or government can change it without convincing the entire network to upgrade — and there is no economic incentive for any holder to accept inflation.

Source: [Why 21 Million?](https://21ideas.org/pochemu-21-million/), [21M Is Non-Negotiable](https://21ideas.org/21-million-ne-podlezhit-obsuzhdeniyu/)
...
**Myths about halvings:**
- Price does not *automatically* rise after a halving (though supply shock + demand = price pressure)
- Miners will not all quit — [[en/concepts/difficulty-adjustment|difficulty adjusts]] downward if hash rate drops
- The network does not break — it adapts

Source: [Bitcoin Myths](https://21ideas.org/bitcoin-myths/)
...
1. Consensus rules enforced by all [[en/concepts/bitcoin-node|full nodes]]
...
- [21M Is Non-Negotiable](https://21ideas.org/21-million-ne-podlezhit-obsuzhdeniyu/)
- [Why 21 Million?](https://21ideas.org/pochemu-21-million/)
- [Bitcoin Myths](https://21ideas.org/bitcoin-myths/)

## Related pages

- [[en/concepts/bitcoin|Bitcoin — the system that enforces scarcity]]
- [[en/concepts/proof-of-work|Proof of Work — how scarcity is enforced on-chain]]
- [[en/concepts/mining|Mining — block rewards and the halving schedule]]
- [[en/concepts/difficulty-adjustment|Difficulty Adjustment — ensures the halving doesn't break the network]]
- [[en/concepts/governance|Governance — how the 21M cap is protected]]
- [[en/concepts/money|Money — why scarcity matters for sound money]]
- [[en/books/bullish-case|The Bullish Case for Bitcoin — scarcity as investment thesis]]
- [[en/books/sovereignty-through-mathematics|Sovereignty Through Mathematics — scarcity as core theme]]
