...
Between the base chain and the application layer sits Bitcoin Script — a stack-based, intentionally limited programming language that defines spending conditions for each [[en/concepts/utxo|UTXO]].
