...
Changes are proposed as [[en/concepts/governance|BIP]]s (Bitcoin Improvement Proposals) — public documents specifying technical changes. Anyone can write a BIP. Adoption requires:
...
**[[en/concepts/governance|Soft fork]]:** New rules are backward-compatible. Non-upgraded nodes still accept blocks from upgraded nodes. [[en/concepts/segwit|SegWit]] and [[en/concepts/taproot|Taproot]] were soft forks.

**[[en/concepts/governance|Hard fork]]:** New rules break backward compatibility. The chain splits unless all nodes upgrade simultaneously. Hard forks require near-universal consensus — practically impossible in Bitcoin without extraordinary circumstances.
...
[[en/glossary|Glossary]] | [[en/concepts/bitcoin|Bitcoin]] | [[en/concepts/scarcity|21M cap]] | [[en/concepts/segwit|SegWit]] | [[en/concepts/taproot|Taproot]] | [[en/history/blocksize-war|blocksize war]] | [[en/entities/satoshi-nakamoto|Satoshi Nakamoto]] | [[en/books/blocksize-war|The Blocksize War]]

## Related Pages

- [[en/concepts/bitcoin]]] — the system governed this way
- [[en/concepts/scarcity]]] — the most important rule
- [[en/history/blocksize-war]]] — the greatest governance test
- [[en/practice/running-a-node]]] — running a node is how you enforce the rules you believe in
- [[en/entities/satoshi-nakamoto]]] — the governance problem he solved by disappearing
