...
The original method [[en/entities/satoshi-nakamoto|Satoshi]] used. Bitcoin is sent directly to a public key (not an address). The first Bitcoin transaction ever (Satoshi → [[en/entities/hal-finney|Hal Finney]], block 170) used P2PK.
...
First native [[en/concepts/segwit|SegWit]] address type, introduced with the SegWit [[en/concepts/governance|soft fork]] (August 2017). The SegWit equivalent of [[en/concepts/address-types|P2PKH]].

**Advantages over P2PKH:**
- Witness data (signatures) gets a 75% discount in [[en/concepts/segwit|block weight]] → lower fees
- Fixes [[en/concepts/segwit|transaction malleability]]
- Better for [[en/concepts/lightning-network|Lightning Network]]

**Addresses start with `bc1q`**, 42 characters, [[en/concepts/segwit|Bech32]] encoded (no uppercase letters, better error detection).
...
**Key features:**
- [[en/concepts/taproot|Schnorr]] signatures instead of ECDSA
...
- **All [[en/concepts/address-types|P2TR]] outputs look identical on-chain** — whether a single-sig, a 5-of-7 [[en/concepts/security|multisig]], a Lightning channel, or a complex contract; this dramatically improves [[en/concepts/privacy|privacy]]

**Addresses start with `bc1p`**, 62 characters, Bech32m encoded.

See [[en/concepts/taproot]]] for full details.
...
**Hardware wallets:** [[en/practice/storage|Coldcard]], [[en/practice/storage|SeedSigner]], Foundation Passport all support [[en/concepts/address-types|P2TR]] as of 2023+.
...
[[en/glossary|Glossary]] | [[en/concepts/segwit|SegWit]] | [[en/concepts/taproot|Taproot]] | [[en/concepts/utxo|UTXO]] | [[en/concepts/privacy|privacy]] | [[en/concepts/security|multisig]] | [[en/concepts/lightning-network|Lightning Network]] | [[en/practice/storage|hardware wallets]]

## Related Pages

- [[en/concepts/segwit]]] — SegWit introduced P2WPKH and P2WSH
- [[en/concepts/taproot]]] — Taproot introduced P2TR
- [[en/concepts/utxo]]] — addresses lock UTXOs
- [[en/concepts/privacy]]] — address types affect privacy
- [[en/glossary]]] — all address types defined
