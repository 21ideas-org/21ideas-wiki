...
Bitcoin [[en/concepts/mining|mining]] is the process of:
1. Collecting pending transactions from the [[en/glossary|mempool]] into a candidate block
...
Bitcoin uses the **[[en/concepts/mining|SHA-256]]** (Secure Hash Algorithm, 256-bit) hash function. Properties:
...
**[[en/concepts/mining|ASIC]] (Application-Specific Integrated Circuit):** Chips designed exclusively to compute [[en/concepts/mining|SHA-256]] hashes. Far more efficient than CPUs or GPUs for this task.
...
Source: `raw/Theory/economics/bitcoin-is-not-harmful-for-the-environment.md`, [[en/series/gradually-then-suddenly]]] Part 4.
...
[[en/glossary|Glossary]] | [[en/concepts/proof-of-work|Proof of Work]] | [[en/concepts/scarcity|scarcity / halving]] | [[en/concepts/bitcoin|Bitcoin]] | [[en/concepts/governance|full nodes]] | [[en/concepts/utxo|UTXO]] | [[en/entities/satoshi-nakamoto|Satoshi Nakamoto]] | [[en/topics/network-effects|network effects]]

## Related Pages

- [[en/concepts/proof-of-work]]] — the underlying mechanism
- [[en/concepts/scarcity]]] — mining as the issuance mechanism
- [[en/concepts/bitcoin]]] — the system mining secures
- [[en/glossary]]] — ASIC, nonce, hash rate, mining pool, block reward defined
