...
completeness: "high"
language: "en"
tags: [bitcoin, wiki, concept, mining, protocol]
updated: "2026-04-07"
reviewed: "2026-04-14"
---
...
1. Collecting pending transactions from the [[en/concepts/mempool|mempool]] into a candidate block
2. Finding a valid [[en/concepts/proof-of-work|Proof of Work]] hash for that block
...
Source: [Mining Walkthrough](https://21ideas.org/mining-walkthrough)
...
- Timestamp
- [[en/concepts/difficulty-adjustment|Difficulty target]]
- **Nonce** (a 32-bit number that miners vary)

**The mining loop:**
1. Construct a candidate block
2. Hash the block header with SHA-256d
3. Check if the hash is below the [[en/concepts/difficulty-adjustment|difficulty target]] (starts with enough zeros)
...
Every **2,016 blocks** (~2 weeks), all [[en/concepts/bitcoin-node|nodes]] independently recalculate the difficulty target:
...
Source: [Difficulty Adjustment](https://21ideas.org/difficulty/)
...
[[en/concepts/scarcity|Block reward]] = **block subsidy + transaction fees**.
...
After the subsidy reaches zero (~2140), miners are compensated entirely by transaction fees. The sources argue this is sufficient for network security — as Bitcoin adoption grows, fee revenue will increase even as the subsidy drops. See [[en/concepts/scarcity]].

## Energy and Environment

Bitcoin mining consumes significant energy — this is intentional ([[en/concepts/proof-of-work|PoW]] security requires cost). Key arguments from the sources:
...
- [[en/concepts/difficulty-adjustment|Difficulty Adjustment — how the target recalibrates every 2,016 blocks]]
- [[en/concepts/mempool|Mempool — where miners source unconfirmed transactions]]
- [[en/concepts/scarcity|Scarcity — mining as the issuance mechanism; the halving schedule]]
- [[en/concepts/utxo|UTXO — what inputs and outputs miners validate]]
- [[en/concepts/bitcoin-node|Full nodes — enforce the rules miners must follow]]
- [[en/concepts/bitcoin|Bitcoin — the system mining secures]]
- [[en/topics/network-effects|Network effects — why miner participation reinforces Bitcoin's security]]
- [[en/entities/satoshi-nakamoto|Satoshi Nakamoto — designed the mining and issuance mechanism]]
