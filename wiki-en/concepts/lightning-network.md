...
The Lightning Network (LN) is a Layer 2 payment protocol built on top of Bitcoin. It enables near-instant, low-fee micropayments without recording every transaction on the blockchain. Two parties open a [[en/concepts/lightning-network|payment channel]] by locking BTC in a [[en/concepts/security|multisig]] [[en/concepts/utxo|UTXO]] on-chain; they can then exchange unlimited signed commitment transactions off-chain; they settle to the blockchain only when closing the channel.

Multi-hop routing uses **[[en/concepts/lightning-network|HTLC]] (Hash Time Lock Contracts)** to enable payments between parties who don't share a direct channel, without either party needing to trust the intermediary routers.
...
[[en/concepts/segwit|SegWit]] (2017) was the prerequisite: it fixed [[en/concepts/segwit|transaction malleability]], which was required for Lightning's commitment transaction scheme to work. Lightning was designed alongside SegWit.

---

## How Payment Channels Work

1. Alice and Bob create a 2-of-2 [[en/concepts/security|multisig]] address and both sign a funding transaction (on-chain)
...
See [[en/practice/lightning-tools]]] for setup guides.
...
[[en/glossary|Glossary]] | [[en/concepts/bitcoin|Bitcoin]] | [[en/concepts/utxo|UTXO]] | [[en/concepts/segwit|SegWit]] | [[en/concepts/taproot|Taproot]] | [[en/concepts/privacy|privacy]] | [[en/concepts/security|multisig]] | [[en/practice/lightning-tools|Lightning tools]] | [[en/entities/gigi|Gigi]]

## Related Pages

- [[en/concepts/bitcoin]]] — the base layer
- [[en/concepts/utxo]]] — channels are UTXOs
- [[en/concepts/privacy]]] — Lightning privacy considerations
- [[en/practice/lightning-tools]]] — practical tools
- [[en/entities/gigi]]] — value-for-value philosophy
