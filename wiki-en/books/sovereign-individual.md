...
1. Transition period 2000 (the turning point)
2. Metapolitical transformations — how violence and coercion change over time
3. East of Eden — the fall of the nation-state
4. The Last Days of Politics
5. The Nation-State as Cartel (for protection services)
6. Megapolitics of the Information Age
7. Beyond Locality — geography becomes less relevant
8. The End of Equalizing Economics — end of mass redistribution
9. Nationalism and the New Luddites — resistance to change
10. The Twilight of Democracy
11. Morality and Crime in the Natural Economy
12. Summary: The Sovereign Individual
...
This prediction describes what [[en/concepts/bitcoin|Bitcoin]] and [[en/concepts/security|self-custody]] enable today.
...
The Bitcoin community treats *The Sovereign Individual* as prophecy. Bitcoin is literally the "digital cash" the authors predicted. The book's analytical framework for understanding state power and individual sovereignty maps directly onto Bitcoin's value proposition: [[en/concepts/money|sound money]] that the state cannot inflate or confiscate. See [[en/concepts/security|self-custody]] for the practical implications.
...
[[en/glossary|Glossary]] | [[en/concepts/bitcoin|Bitcoin]] | [[en/concepts/money|sound money]] | [[en/concepts/security|self-custody]] | [[en/concepts/governance|governance]] | [[en/entities/cypherpunks|cypherpunks]] | [[en/philosophy/overview|philosophy overview]] | [[en/books/price-of-tomorrow|The Price of Tomorrow]]

## Related Pages

- [[en/concepts/bitcoin]]] — the digital cash they predicted
- [[en/concepts/governance]]] — how Bitcoin resists state control
- [[en/philosophy/overview]]] — libertarian cyberspace theme
- [[en/books/price-of-tomorrow]]] — complementary economic analysis
