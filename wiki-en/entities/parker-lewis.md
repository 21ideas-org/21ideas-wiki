...
completeness: "medium"
language: "en"
tags: [bitcoin, wiki, entity, economics]
updated: "2026-04-14"
reviewed: "2026-04-14"
---
...
See also: [[en/series/gradually-then-suddenly|Gradually, Then Suddenly]], [[en/concepts/money|Money]], [[en/concepts/scarcity|Scarcity]], [[en/books/bullish-case|Bullish Case for Bitcoin]]

## Background

Parker Lewis approaches [[en/concepts/bitcoin|Bitcoin]] from a first-principles economic perspective rather than a technical one. He does not primarily argue about cryptography or network architecture — he argues about money: what it is, why it matters, why Bitcoin solves the problem fiat cannot, and why every common objection to Bitcoin fails at the root level.

At Unchained Capital, Lewis has been at the center of institutional Bitcoin custody and financial services built on [[en/concepts/multisig|multisig]]. His professional work gives him a ground-level view of how individuals and institutions actually hold and use Bitcoin, which informs the practical dimensions of his writing.
...
1. **State the objection** as its proponents state it — charitably and precisely
2. **Identify the root assumption** the objection rests on
3. **Examine that assumption** using first-principles economics, usually Austrian
4. **Show why the assumption fails** — why Bitcoin's properties actually satisfy the monetary requirement being questioned
5. **Conclude** with what the correct understanding implies
...
**Bitcoin Is Not Too Slow** — Distinguishes between final settlement and payment layer. Bitcoin's base layer settles value with finality; speed is the job of layers above it ([[en/concepts/lightning-network|Lightning]]). Visa is not the settlement layer — it is the payment rail above the Fed settlement system.
...
- [[en/books/bullish-case|Bullish Case for Bitcoin]] (Vijay Boyapati) — covers similar monetary-evolution argument but at shorter length; Lewis goes deeper on objections
- [[en/concepts/money|Money]] — Lewis's essays are a primary source for the monetary theory section
- [[en/concepts/scarcity|Scarcity]] — Lewis's supply-fixity argument is the analytical core of Bitcoin's scarcity
- [[en/entities/saifedean-ammous|Saifedean Ammous]] — Both draw from Austrian economics; Ammous provides the academic framework in *The Bitcoin Standard*; Lewis applies it to specific objections
...
- [[en/series/gradually-then-suddenly|Gradually, Then Suddenly — full series summary and individual essay breakdowns]]
- [[en/concepts/money|Money — monetary theory underpinning Lewis's argument]]
- [[en/concepts/scarcity|Scarcity — Bitcoin's fixed supply and halving schedule]]
- [[en/concepts/bitcoin|Bitcoin — the monetary network Lewis defends]]
- [[en/concepts/lightning-network|Lightning Network — the payment layer Lewis distinguishes from base-layer settlement]]
- [[en/books/bullish-case|Bullish Case for Bitcoin — complementary case for Bitcoin as monetary asset]]
- [[en/entities/saifedean-ammous|Saifedean Ammous — parallel work in the Austrian Bitcoin tradition]]
