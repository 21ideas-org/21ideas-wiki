...
See also: [[en/books/fiat-standard|The Fiat Standard]], [[en/concepts/money|Money]], [[en/concepts/scarcity|Scarcity]], [[en/concepts/cantillon-effect|Cantillon Effect]]
...
**Altcoins as Soft Money** — Ammous is categorical: no altcoin can replicate Bitcoin's monetary properties because any coin controlled by a founding team, foundation, or single developer has a trusted party who can alter the supply. The monetary hardness of Bitcoin is produced by its [[en/concepts/decentralization|decentralization]], and that decentralization cannot be copied. See also: [[en/entities/parker-lewis|Parker Lewis]] on why Bitcoin cannot be copied.
...
**The Cantillon Effect at Scale** — New money injected into the economy does not distribute uniformly. Those closest to the money printer (banks, government contractors, asset holders) receive it first, at pre-inflation prices. By the time it reaches wage earners, prices have risen. This systematic wealth transfer is the [[en/concepts/cantillon-effect|Cantillon Effect]] operating continuously. Ammous argues this is not a bug of fiat — it is the mechanism by which the financial class extracts from the productive class.
...
*The Bitcoin Standard* is the backbone of the 21ideas.org library's economics section. Multiple articles in the library cite it as foundational reading. The [[en/books/fiat-standard|Fiat Standard]] wiki page covers both books in detail. The [[en/concepts/money|Money]], [[en/concepts/scarcity|Scarcity]], and [[en/concepts/cantillon-effect|Cantillon Effect]] pages draw heavily from Ammous's framework.
...
- [[en/books/fiat-standard|The Fiat Standard — full summary of both The Bitcoin Standard and The Fiat Standard]]
- [[en/concepts/money|Money — monetary theory; Ammous is a primary source]]
- [[en/concepts/scarcity|Scarcity — stock-to-flow, halving, 21M supply]]
- [[en/concepts/cantillon-effect|Cantillon Effect — the fiat wealth-transfer mechanism Ammous analyzes]]
- [[en/concepts/bitcoin|Bitcoin — the monetary asset Ammous argues for]]
- [[en/concepts/decentralization|Decentralization — why Bitcoin's monetary hardness cannot be copied]]
- [[en/entities/parker-lewis|Parker Lewis — parallel Austrian Bitcoin analysis via the "Gradually, Then Suddenly" series]]
