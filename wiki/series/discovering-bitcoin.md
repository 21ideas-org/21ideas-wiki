...
Humans have time preferences: we'd rather have something now than later. The first problem of trade is bridging time. Early collectibles solved this by letting people save value between trades.
...
With digital scarcity (Bitcoin) comes the ability to encode contracts directly in the money. Multisig, timelocks, HTLCs — the money becomes programmable. Lightning is the logical extension.
