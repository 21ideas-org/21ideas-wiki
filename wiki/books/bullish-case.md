...
Originally a long-form essay (2018), expanded into a book. Boyapati builds the investment case for Bitcoin from first principles: starting with the origin and properties of [[concepts/money|money]], proceeding through Bitcoin's unique attributes, and concluding with a model of how Bitcoin's monetization might unfold.
...
- **Absolute [[concepts/scarcity|scarcity]]** ([[concepts/scarcity|21M cap]], mathematically enforced) — gold cannot match this
- **Perfect portability** (travel with any amount via [[concepts/security|seed phrase]]) — gold cannot match this
...
3. **Medium of exchange** (ongoing): [[concepts/lightning-network|Lightning Network]] enables small transactions as store-of-value adoption matures
...
[[glossary|Glossary]] | [[concepts/money|sound money]] | [[concepts/scarcity|scarcity]] | [[concepts/bitcoin|Bitcoin]] | [[concepts/security|self-custody]] | [[topics/network-effects|network effects]] | [[books/fiat-standard|The Fiat Standard]] | [[series/gradually-then-suddenly|Gradually, Then Suddenly]]

## Related Pages

- [[concepts/money]] — the monetary theory underlying the argument
- [[concepts/scarcity]] — the core attribute
- [[books/fiat-standard]] — complementary critique of fiat
- [[books/sovereignty-through-mathematics]] — philosophical companion
- [[series/gradually-then-suddenly]] — overlapping economic argument
